...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/late-grass-0513
```

A live public deployment of this template is available at [https://late-grass-0513.templates.workers.dev](https://late-grass-0513.templates.workers.dev)
